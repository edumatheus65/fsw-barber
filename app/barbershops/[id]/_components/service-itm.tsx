...
import { formatCurrency } from "@/app/helpers/priceHelpers";
  ...
  const handleBookingSubmit = async () => {
    ...
    try {
      ...
      toast("Reserva realizada com sucesso!", {
        description: formatDateHour(utcDate),
        action: {
          label: "Visualizar",
  ...
  const timeList = useMemo(() => {
    ...
    const availableTimes = generatedTimes.filter((time) => {
      ...
      const booking = dayBookings.find((booking) => {
        const bookingHour = booking.date.getUTCHours();
        const bookingMinute = booking.date.getUTCMinutes();
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <Sheet open={sheetIsOpen} onOpenChange={setSheetIsOpen}>
                ...
                <SheetContent className="p-0">
                  ...
                  <div className="py-6 px-5 gap-3 border-t border-solid border-secondary">
                    <Card>
                      <CardContent className="p-3">
                        ...
                        {date && (
                          <div className="flex justify-between">
                            ...
                            <h4 className="text-sm">{formatedDayMonth}</h4>
                          </div>
                        )}
